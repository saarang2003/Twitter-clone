                ...
                <div className='text-right m-4'>
                    {
                        profile?._id === user?._id ? (
                            ...
                            <button onClick={followAndUnfollowHandler}  className='px-4 py-1 bg-black text-white rounded-full border border-gray-400'>{user.following.includes(id) ? "Following" : "Follow"}</button>
                        )
                    }
                </div>
                <div className='m-4'>
